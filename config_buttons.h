...
// Times are in miliseconds
 ...
 #define KEYPAD_DEBOUNCE_TIME 50
...
// must be 1 or greater
    ...
    #define NEW_ADDITIONAL_BUTTON_ACTIONS {FUNCTION_10,FUNCTION_4,FUNCTION_3,E_STOP_CURRENT_LOCO,FUNCTION_0,NEXT_THROTTLE,FUNCTION_2,FUNCTION_1}

    #define NEW_ADDITIONAL_BUTTON_LATCHING {true,false,false,true,true,true,false,true,}
